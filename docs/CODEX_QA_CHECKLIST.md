...
- [ ] A failing Coin component is reported as a component/platform bug; QA has not hidden it with custom CSS, wrappers, recreated internals, or screen-level behavioral patches.
